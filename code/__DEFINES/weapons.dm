...
#define FULL_AUTO_1200		list(mode_name = "fullest auto",  mode_desc = "1200 rounds per minute",   mode_type = /datum/firemode/automatic, fire_delay = 0.5,   icon="auto", damage_mult_add = -0.2)
...
#define FULL_AUTO_600_NOLOSS		list(mode_name = "full auto",  mode_desc = "600 rounds per minute",   mode_type = /datum/firemode/automatic, fire_delay = 1,   icon="auto")
#define FULL_AUTO_800_NOLOSS		list(mode_name = "fuller auto",  mode_desc = "800 rounds per minute",   mode_type = /datum/firemode/automatic, fire_delay = 0.8  , icon="auto")
#define FULL_AUTO_1200_NOLOSS		list(mode_name = "fullest auto",  mode_desc = "1200 rounds per minute",   mode_type = /datum/firemode/automatic, fire_delay = 0.5,   icon="auto")
